...
<main role="main" class="content-wrapper">
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3"><h1 class="h2 text-center"> All Assignment</h1>
    
  </div>

  <div class="col-12">
    <?php
    $sentencia = $base_de_datos->query("SELECT * FROM facility_assignment, individuals, species WHERE species.id_species = individuals.specie AND individuals.id_individual = facility_assignment.id_individual_assi ORDER BY facility_assignment.id_assignment");
          ...
          <table id="example1" class="table table-bordered table-striped table-responsive">
            ...
            <tbody>
              <?php foreach($usuario as $individuals) { ?>
                ...
                <td width="10%"><center><?php if($individuals->finish_date === null){
                  echo "empty";
                }else{
                  echo $individuals->finish_date;
                } ?></center></td>
