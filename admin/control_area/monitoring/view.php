...
?>
    ...
    <main role="main" class="content-wrapper col-12">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Monitoring For All</h1>
...
<!-- Content Wrapper. Contains page content -->
    ...
    <div class="col-xs-12">
          ...
          <!-- <td>
            <center><a class="btn btn-warning btn-sm" href="<?php echo "update_individual_monitoring.php?id=" . $individuals->id_monitoring?>"><span data-feather="edit"></span></a></center>
          </td>
           <td>
