...
<?php
$sentencia = $base_de_datos->query("SELECT * FROM monitoring, individuals WHERE monitoring.id_individual_mon= individuals.id_individual AND id_individual_mon='".$id."'");
...
<!-- Content Wrapper. Contains page content -->
    ...
    <div class="col-xs-12">
        ...
        <tr>
          ...
          <td><center><?php echo $individuals->id_monitoring ?></center></td>
