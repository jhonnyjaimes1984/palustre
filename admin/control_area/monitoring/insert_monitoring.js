...
function formatTime(seconds) {
    ...
    function loadContent(file) {
        let contentDiv = document.getElementById("controlContent");
     ...
     function toggleBehaviorOptions() {
        let checkbox = document.getElementById("basic_behavioral");
        let behaviorOptions = document.getElementById("behavior_options");
        ...
        if (checkbox.checked) {
            behaviorOptions.innerHTML = `
                <ul>
                    ...
                    <li>
                        <input type="checkbox" id="lethargic" name="lethargic">
                    ...
                    <li>
                        <input type="checkbox" id="evasive" name="evasive">
     ...
     function toggleSocialOptions() {
        let checkbox = document.getElementById("social_interactions");
        let socialOptions = document.getElementById("social_options");

        if (checkbox.checked) {
            socialOptions.innerHTML = `
                <ul>
                    <li>
                        <input type="checkbox" id="vocalizing" name="vocalizing"> 
                        <label class="form-check-label" for="vocalizing" ondblclick="toggleTextarea(this)" data-text="ESP/Vocalizaciones. Displays vocal behaviors such as singing, territorial calls, or attracting a mate. Muestra comportamientos vocales como canto, llamadas territoriales o atracción de pareja."> Vocalizing</label>
                    </li>
                    <li>
                        <input type="checkbox" id="sociable" name="sociable"> 
                        <label class="form-check-label" for="sociable" ondblclick="toggleTextarea(this)" data-text="ESP/Sociable. Positive interaction with other specimens in the enclosure. Interacción positiva con otros ejemplares en la jaula."> Sociable</label>
                    </li>
                    <li>
                        <input type="checkbox" id="dominant" name="dominant"> 
                        <label class="form-check-label" for="dominant" ondblclick="toggleTextarea(this)" data-text="ESP/Dominante. Displays controlling behavior over others (e.g., monopolizing food or space). Conductas de control sobre otros ejemplares (e.g., monopolización del alimento o territorio)."> Dominant</label>
                    </li>
                    <li>
                        <input type="checkbox" id="submissive" name="submissive"> 
                    ...
                    <li>
                        ...
                        <label class="form-check-label" for="isolated" ondblclick="toggleTextarea(this)" data-text="ESP/Aislado. The specimen voluntarily separates from the group. El ejemplar se separa voluntariamente del grupo."> Isolated</label>
                    </li>
                </ul>
            `;
        } else {
    ...
    function toggleEnvironmentResponses() {
        let checkbox = document.getElementById("responses_environment");
        let environmentOptions = document.getElementById("environment_options");
            ...
            environmentOptions.innerHTML = `
                <ul>
                    <li>
                        ...
                        <label class="form-check-label" for="alert" ondblclick="toggleTextarea(this)" data-text="ESP/Alerta. Displays a heightened state of vigilance due to fear, often in response to unfamiliar caretakers, sudden noises, or perceived threats. Muestra un estado elevado de vigilancia debido al miedo, a menudo en respuesta a cuidadores desconocidos, ruidos repentinos o amenazas percibidas."> Alert</label>
                    </li> 
                    <li>
                        <input type="checkbox" id="curious" name="curious"> 
                        <label class="form-check-label" for="curious" ondblclick="toggleTextarea(this)" data-text="ESP/Curioso. Actively investigates new objects or changes in the environment. Explora activamente nuevos objetos o cambios en el entorno."> Curious</label>
                    </li> 
                    <li>
                        <input type="checkbox" id="stressed" name="stressed"> 
                        <label class="form-check-label" for="stressed" ondblclick="toggleTextarea(this)" data-text="ESP/Estresado. Signs of stress such as excessive vocalizations, repetitive movements, or feather loss. Signos de estrés como vocalizaciones excesivas, movimientos repetitivos o pérdida de plumaje."> Stressed</label>
                    </li> 
                    <li>
                        <input type="checkbox" id="adaptive" name="adaptive"> 
                        <label class="form-check-label" for="adaptive" ondblclick="toggleTextarea(this)" data-text="ESP/Adaptado. Quickly adjusts to changes in the environment (e.g., new enclosure or companions). Se ajusta rápidamente a cambios en el ambiente (e.g., nueva jaula o compañía)."> Adaptive</label>
                    </li>
                    <li>
                        <div>
                            <label for="time_birds_movements">Time Birds Movements:</label>
                            <input type="text" id="time_birds_movements" name="time_birds_movements" value="00:00:00" readonly>
     ...
     function toggleFeedingBehaviors() {
        let checkbox = document.getElementById("feeding_behaviors");
        let feedingOptions = document.getElementById("feeding_options");

        if (checkbox.checked) {
            feedingOptions.innerHTML = `
                <ul>
                    <li>
                        <input type="checkbox" id="search_wall" name="search_wall">  
                        <label class="form-check-label" for="search_wall" ondblclick="toggleTextarea(this)" data-text="ESP/Busca comida por las paredes y techo. The bird searches for food along the walls and ceiling of the enclosure, possibly pecking at insects or debris."> Search for Food on Walls and Ceiling</label>
                    </li>
                    <li>
    ...
    function togglePathologicalBehaviors() {
        let checkbox = document.getElementById("pathological_behaviors");
        let pathologicalOptions = document.getElementById("pathological_options");
     ...
     function toggleSexualBehaviors() {
        let checkbox = document.getElementById("sexual_behaviors");
        let container = document.getElementById("sexual_behaviors_options");
     ...
     function toggleCopulationBehaviors() {
        let checkbox = document.getElementById("copulation_behaviors");
        let container = document.getElementById("copulation_behaviors_options");
    ...
    function toggleNestBehaviors() {
        let checkbox = document.getElementById("nest_behaviors");
        let container = document.getElementById("nest_behaviors_options");
    ...
    function toggleIncubationBehaviors() {
        let checkbox = document.getElementById("incubation_behaviors");
        let container = document.getElementById("incubation_behaviors_options");
      ...
      function toggleChickenNestBehaviors() {
        let checkbox = document.getElementById("chicken_nest_behaviors");
        let container = document.getElementById("chicken_nest_behaviors_options");
     ...
     function toggleChickenFledglingsBehaviors() {
        let checkbox = document.getElementById("chicken_fledglings_behaviors");
        let container = document.getElementById("chicken_fledglings_behaviors_options");
     ...
     function toggleChickenAttackBehaviors() {
        let checkbox = document.getElementById("chicken_attack_behaviors");
        let container = document.getElementById("chicken_attack_behaviors_options");
    ...
    function toggleJuvenilBehaviors() {
        let checkbox = document.getElementById("juvenil_behaviors");
        let container = document.getElementById("juvenil_behaviors_options");
