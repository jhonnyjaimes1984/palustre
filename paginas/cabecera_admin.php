...
<head>
  ...
  <link rel="icon" href="../imagen/imagen_2.png">
...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-primary elevation-4" style="background-color: #00008B;" >
      <!-- Brand Logo -->
      <a href="../admin/admin.php" class="brand-link"><img src="../image/imagen_2.png" alt="" class="img-size-100 mr-3" width="60" height="60"> BD PALUSTRES </a>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                <a class="nav-link" href="../admin/admin.php" style="color: #ffffff;">
                 <img src="../icons/home.png" alt="" class="img-size-100 mr-3" width="45" height="45">
                 <p> Home </p>
               </a>
             </li>
             <li class="nav-item has-treeview">
               <a href="../admin/stock_birds/stock_birds.php" class="nav-link" style="color: #ffffff;" id="stockBirdsLink">
              ...
              <ul class="nav nav-treeview">
               <li class="nav-item">
                <a href="../admin/stock_birds/select.php" class="nav-link" style="color: #ffffff;">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../admin/stock_birds/insert_stockbirds.php" class="nav-link" style="color: #ffffff;">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Insert</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../admin/stock_birds/update_stockbirds.php" class="nav-link" style="color: #ffffff;">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Update</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../admin/stock_birds/delete_stockbirds.php" class="nav-link" style="color: #ffffff;">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Delete</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
             <a href="../admin/control_area/select_control_area.php" class="nav-link" style="color: #ffffff;" id="select_control_area">
            ...
            <ul class="nav nav-treeview">
             <li class="nav-item">
              <a href="../admin/control_area/monitoring/select_monitoring.php" class="nav-link" style="color: #ffffff;">
                <img src="../icons/monitoring.png" alt="" class="img-size-100 mr-3" width="30" height="30">
                <p>Monitoring</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="../admin/control_area/preventive_care/select_preventive_care.php" class="nav-link" style="color: #ffffff;">
                <img src="../icons/preventive_care.png" alt="" class="img-size-100 mr-3" width="30" height="30">
                <p>Preventive Care</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="../admin/control_area/veterinary/select_veterinary.php" class="nav-link" style="color: #ffffff;">
                <img src="../icons/veterinary.png" alt="" class="img-size-100 mr-3" width="30" height="30">
                <p>Veterinary</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="../admin/control_area/assignment/select_assignment.php" class="nav-link" style="color: #ffffff;">
        ...
        <li class="nav-item has-treeview">
          <a href="../admin/bredding_area/select_breeding_area.php" class="nav-link" style="color: #ffffff;" id="select_breeding_area">
        ...
        <ul class="nav nav-treeview">
         <li class="nav-item">
          <a href="../admin/bredding_area/pairs/select_pairs.php" class="nav-link" style="color: #ffffff;">
            <img src="../icons/pairs.png" alt="" class="img-size-100 mr-3" width="30" height="30">
            <p>Pairs</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="../admin/bredding_area/clutches/select_clutches.php" class="nav-link" style="color: #ffffff;">
            <img src="../icons/egg.png" alt="" class="img-size-100 mr-3" width="30" height="30">
            <p>Clutches</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="../admin/bredding_area/egg/select_egg.php" class="nav-link" style="color: #ffffff;">
            <img src="../icons/egg.png" alt="" class="img-size-100 mr-3" width="30" height="30">
            <p>Egg</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="../admin/bredding_area/incubation/select_incubation.php" class="nav-link" style="color: #ffffff;">
            <img src="../icons/incubation.png" alt="" class="img-size-100 mr-3" width="30" height="30">
            <p>Incubation</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="../admin/bredding_area/chickens/select_chickens.php" class="nav-link" style="color: #ffffff;">
            <img src="../icons/chickens.png" alt="" class="img-size-100 mr-3" width="30" height="30">
            <p>Chickens</p> <!-- hasta aqui todo ok -->
          </a>
        </li>
      </ul>
    </li>
    ...
    <li class="nav-item has-treeview">
      <a href="../admin/ex_situ_area/select_ex_situ_area.php" class="nav-link" style="color: #ffffff;" id="select_ex_situ_area">
     ...
     <ul class="nav nav-treeview">
       <li class="nav-item">
        <a href="../admin/ex_situ_area/release/select_release.php" class="nav-link" style="color: #ffffff;">
  ...
  <li class="nav-item">
    <a href="../admin/ex_situ_area/tracking/select_tracking.php" class="nav-link" style="color: #ffffff;">
...
<li class="nav-item has-treeview">
  <a href="../admin/management_area/select_management_area.php" class="nav-link" style="color: #ffffff;" id="select_management_area">
...
<ul class="nav nav-treeview">
 <li class="nav-item">
  <a href="../admin/management_area/species/select_species.php" class="nav-link" style="color: #ffffff;">
   <img src="../icons/species.png" alt="" class="img-size-100 mr-3" width="30" height="30">
   <p>Species</p>
 </a>
</li>
<li class="nav-item">
  <a href="../admin/management_area/origin/select_origin.php" class="nav-link" style="color: #ffffff;">
   <img src="../icons/origin.png" alt="" class="img-size-100 mr-3" width="30" height="30">
   <p>Origin</p>
 </a>
</li>
<li class="nav-item">
  <a href="../admin/management_area/facilities/select_facilities.php" class="nav-link" style="color: #ffffff;">
    <img src="../icons/facilities.png" alt="" class="img-size-100 mr-3" width="30" height="30">
    <p>Facilities</p>
  </a>
</li>
<li class="nav-item">
  <a href="../admin/management_area/nest/select_nest.php" class="nav-link" style="color: #ffffff;">
    <img src="../icons/nest.png" alt="" class="img-size-100 mr-3" width="30" height="30">
    <p>Nest</p>
  </a>
</li>
<li class="nav-item">
  <a href="../admin/management_area/staff/select_staff.php" class="nav-link" style="color: #ffffff;">
   <img src="../icons/staff.png" alt="" class="img-size-100 mr-3" width="30" height="30">
   <p>Staff</p>
 </a>
</li>
<li class="nav-item">
  <a href="../admin/management_area/privileges/select_privileges.php" class="nav-link" style="color: #ffffff;">
